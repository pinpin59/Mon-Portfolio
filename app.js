...
.pauseFor(1400)
.changeDelay(20)
.typeString('Moi c\'est Kevin Pintar')
.pauseFor(300)
...
const hobbiesTitre = document.querySelector('.hobbies-txt');
const tlpres = new TimelineMax();

tlpres
.from(titrePres, {y: -200, opacity:0, duration: 0.6})
.from(presGauche, {y: -20, opacity:0, duration:0.6}, '-=0.5')
.staggerFrom(hobbiesTitre, 1, {opacity:0}, 0.2, '-=0.5')
...
const allPourcent = document.querySelectorAll('.number-exp');
